        ...
        <div className='card-overlay' id='resumeOverlay'>          
          ...
          <div className="aboutContentAll">
            ...
            <div className='aboutContainer'>          
              <p id="intro">
                <p>My name is Maxwell Morris, but you can just call me Max! I am currently attending the University of Maryland, 
                College Park in my last year pursuing a Master&apos;s degree in Human-Computer Interaction.</p>
                <p>I was introduced to technology at a very young age, which has fostered an interest that played a huge role in 
                ...
                <p>In my spare time, I like to expand my sizeable library of games.
            ...
            <div className='myMission'>
              ...
              <p id='missionText'>
              <p>
              My love for computers and tech is matched by my strong desire to help others. I take pride in my strong
